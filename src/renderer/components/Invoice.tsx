...
const Invoice = (props: any) => {
  ...
  // const commits = [
  //   {
  //     date: '2019-10-08 18:04:33 -0700',
  //     author: 'Dylan Bishop',
  //     email: 'dbishoponline@gmail.com',
  //     parent: '661423c133875841734e494da4d357191a04623f',
  //     abbreviated_commit: 'ab5ee8e',
  //     subject: 'updates evrlyt_home_raspberrypi submodule',
  //     body: ''
  //   },
  //   {
  //     date: '2019-10-08 18:04:08 -0700',
  //     author: 'Dylan Bishop',
  //     email: 'dbishoponline@gmail.com',
  //     parent: 'd77490b7251c5a50e90ef9216d228513a76d2062',
  //     abbreviated_commit: '661423c',
  //     subject: '- updates test.sh so it logs into the device and runs the "make && make test" command so it runs the devices test - adds update_dev.sh - adds update.sh',
  //     body: ''
  //   }
  // ];
  ...
  return (
    <div>
      <ul>
        {commits.map((item: any, i, arr) => (
          <li key={'${item.commit}-${i}'}>
            <ul>
              <li>{ item.author.name }</li>
              <li>{ item.author.email }</li>
              <li>{ moment(item.author.date, '').format('LL') }</li>
              <li>{ moment(item.author.date).format('MMMM Do YYYY, h:mm:ss a') }</li>
              <li>{ item.message }</li>
            </ul>
          </li>
        ))}
